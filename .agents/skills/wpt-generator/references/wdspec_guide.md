...
To run a wdspec test and validate your Python code, use the standard WPT CLI but specify the specific Python file:
```bash
./wpt run chrome webdriver/tests/bidi/path/to/test.py
```