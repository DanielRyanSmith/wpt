...
@pytest.mark.parametrize("event_path,expected",
                         [("pr_event.json",
                           frozenset(["lint", "wpt-chrome-experimental-stability"])),
...
def test_exclude_users(event_path, expected):
    ...
    tasks = {
        ...
        "wpt-chrome-experimental-stability": {
            "commands": "wpt example",
...
@pytest.mark.parametrize("event_path,is_pr,files_changed,expected", [
    ("master_push_event.json", False, None,
     ['download-firefox-nightly',
      ...
      'download-chrome-experimental',
      'wpt-chrome-experimental-testharness-1',
      'wpt-chrome-experimental-testharness-2',
      'wpt-chrome-experimental-testharness-3',
      'wpt-chrome-experimental-testharness-4',
      'wpt-chrome-experimental-testharness-5',
      'wpt-chrome-experimental-testharness-6',
      'wpt-chrome-experimental-testharness-7',
      'wpt-chrome-experimental-testharness-8',
      'wpt-chrome-experimental-testharness-9',
      'wpt-chrome-experimental-testharness-10',
      'wpt-chrome-experimental-testharness-11',
      'wpt-chrome-experimental-testharness-12',
      'wpt-chrome-experimental-testharness-13',
      'wpt-chrome-experimental-testharness-14',
      'wpt-chrome-experimental-testharness-15',
      'wpt-chrome-experimental-testharness-16',
      ...
      'wpt-chrome-experimental-reftest-1',
      'wpt-chrome-experimental-reftest-2',
      'wpt-chrome-experimental-reftest-3',
      'wpt-chrome-experimental-reftest-4',
      'wpt-chrome-experimental-reftest-5',
      'wpt-firefox-nightly-wdspec-1',
      'wpt-firefox-nightly-wdspec-2',
      'wpt-chrome-experimental-wdspec-1',
      'wpt-chrome-experimental-wdspec-2',
      'wpt-firefox-nightly-crashtest-1',
      'wpt-chrome-experimental-crashtest-1',
      'wpt-firefox-nightly-print-reftest-1',
      'wpt-chrome-experimental-print-reftest-1',
      'lint']),
    ...
    ("pr_event_tests_affected.json", True, {"layout-instability/clip-negative-bottom-margin.html",
     ...
     ['download-firefox-nightly',
      ...
      'download-chrome-experimental',
      'wpt-chrome-experimental-results',
      'wpt-chrome-experimental-results-without-changes',
      'lint',
      'sink-task']),
